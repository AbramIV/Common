...
namespace AppML
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Main\Repositories\Common\AppML\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=85,MinimumExampleCountPerLeaf=19,NumberOfTrees=64,MaximumBinCountPerFeature=539,FeatureFraction=0.99999999,LearningRate=0.999999776672986,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName: @"col1"))      
