...
string enumerator, nint hwndParent, SetupDiGetClassDevsFlags flags);
...
public sealed class DeviceHelper
{
    ...
    public static void SetDeviceEnabled(Guid classGuid, string instanceId, bool enable)
    {
        ...
        try
        {
            ...
            // system.
            diSetHandle = NativeMethods.SetupDiGetClassDevs(ref classGuid, null, nint.Zero, SetupDiGetClassDevsFlags.Present);
